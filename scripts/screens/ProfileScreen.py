...
class ProfileScreen(Screens):
    ...
    EVENT_BUTTON_LOOKUP = {\
                            ...
                            "magnify_button": "inspect_button_callback",\
                            "#mediation_button": "mediation_callback",\
                            "#fav_cat": "fav_callback",\
                            "#not_fav_cat": "not_fav_callback"
                           }
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            ...
            if self.the_cat.dead and game.clan.clan_settings["fading"]:
